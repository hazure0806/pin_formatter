...
df = pd.read_csv(
    'C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\行ってみたい(緑ピン)\\update_address_records.csv'
)
...
# ラベル付きの場所用
new_df.to_csv(
    "C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\行ってみたい(緑ピン)\\t-mappin-customer-addres.csv",
    index=False
)
