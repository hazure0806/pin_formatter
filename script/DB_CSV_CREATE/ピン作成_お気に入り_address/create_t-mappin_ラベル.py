...
# 既存のCSVファイルのパス
existing_csv_path = 'C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\お気に入り(♡ピン)\\update_address_records.csv'
...
# 新しいCSVファイルへの出力パス
# ラベル付きの場所用
new_csv_path = 'C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\お気に入り(♡ピン)\\t-mappin_address.csv'
