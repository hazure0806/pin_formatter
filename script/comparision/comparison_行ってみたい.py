...
address_non_records_df = pd.read_csv(
    "C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\行ってみたい(緑ピン)\\update_address_non_records.csv"
)
updated_with_date_filtered_df = pd.read_csv(
    "C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\ラベル\\last.csv"
)
...
if not matches.empty:
    for index, row in matches.iterrows():
        ...
        updated_with_date_filtered_df.loc[updated_index, 'pin_no'] = 3

# 結果を新しいCSVファイルに保存
address_non_records_df.to_csv('C:\\Users\\14nn0\\works_new\\あおいホーム様\\\script\\行ってみたい(緑ピン)\\last.csv', index=False)
updated_with_date_filtered_df.to_csv('C:\\Users\\14nn0\\works_new\\あおいホーム様\\script\\ラベル\\final_last.csv', index=False)